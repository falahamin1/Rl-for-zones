"""LJS_06: Large benchmark — 10 jobs, 6 machines (60 tasks)."""
...
def get_instance() -> ProbJobShopInstance:
    ...
    raw = [
        ...
        # J4
        [("m4",  9), ("m1", 13), ("m2", 11), ("m6", 10), ("m3", 16), ("m5", 14)],
        # J5
        ...
        # J10
        [("m4", 14), ("m2",  9), ("m5", 16), ("m3", 12), ("m6", 10), ("m1", 13)],
    ]
    jobs = []
    ...
    return ProbJobShopInstance(
        name="LJS_06",
        description="Large-06: 10 jobs, 6 machines, 60 tasks. "
